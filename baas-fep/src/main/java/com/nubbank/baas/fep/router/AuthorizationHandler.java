 ...
 *
 * <p><strong>STUB — full BIN-routing + Card authorize flow implemented in Task 6.
 * Returns RC 96 (system error / not-yet-implemented) as a placeholder.</strong>
 *
...
public class AuthorizationHandler {
    ...
    /**
     * STUB — full implementation in Task 6 (auth flow). Returns RC 96 placeholder.
     *
     * @param req the incoming 0100 authorization request
     * @return a 0110 response with RC 96 (not yet implemented)
     */
    public ISOMsg handle(ISOMsg req) {
        // STUB — full BIN-routing + Card authorize flow implemented in Task 6. Placeholder RC 96.
