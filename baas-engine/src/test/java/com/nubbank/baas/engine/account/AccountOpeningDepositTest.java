...
class AccountOpeningDepositTest extends AbstractIntegrationTest {
    ...
    void setup() {
        ...
        jwt = jwtService.issue(UUID.randomUUID().toString(), "opening@partner.com", "PARTNER_ADMIN",
            org.getId().toString(), "Acct Opening Deposit Test", schemaName, "SANDBOX", "SANDBOX");
    }
