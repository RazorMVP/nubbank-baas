...
// DEF-1C-17 MUST supply a @Profile("live-keycloak") implementation of KeycloakUserDirectory.
// Activating the 'live-keycloak' profile without one will fail context startup
// (NoSuchBeanDefinitionException), because OperatorGrantReconciliationJob requires the bean.
