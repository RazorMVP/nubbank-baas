...
public class RecurringDepositAccount {
    ...
    @Column(name = "mandatory_installment", nullable = false, precision = 19, scale = 4) private BigDecimal mandatoryInstallment;
    @Column(name = "total_deposited", nullable = false, precision = 19, scale = 4) private BigDecimal totalDeposited;
