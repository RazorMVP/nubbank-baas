...
### BaaS Backoffice Portal (`baas-backoffice/`) — FOUNDATION + CUSTOMERS + ACCOUNTS TRACKS (Sessions 14–18)
...
| **Last git commit** | `e96407e` | Session 18 — `UPDATE_ACCOUNT` added to `.env.example` dev authorities (PR #35, merged); dev proxy + `docs/backoffice-local-dev.md` for running against a local engine (PR #36, open). Accounts UI verified end-to-end against a live local engine. 139 unit tests pass. |
