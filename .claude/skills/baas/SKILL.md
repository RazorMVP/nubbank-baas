...
| 1C | `baas-backoffice` — React/Vite operations portal | 🟡 **Foundation ✅** (Session 14/15, `281739a`) — app skeleton, hybrid auth, RBAC gating, dashboard, CI/Docker/k8s. **Customers — first domain track ✅** (Session 16, frontend PR `feat/baas-backoffice-customers` `373ebcd` + engine PR #28 `feat/baas-engine-customer-lifecycle`) — list/detail/create/edit, masked-PII, KYC state machine + history. **Accounts — second domain track ✅** (Session 17, frontend PR #34 `feat/baas-backoffice-accounts` `513ff73` + engine PR #33 `feat/baas-engine-accounts-lifecycle`) — list/detail/open, lifecycle (freeze/unfreeze/close), money-movement (deposit/withdraw), transaction ledger, status-history. Remaining domain tracks (Loans, Payments, Teller, Charges, Accounting, Reports, Compliance, Offices/Staff, Roles, Audit) pending. |
