...
| 1C / D7 | `baas-fep` — stateless ISO 8583 front-end processor (Netty + jPOS + MTI router + BIN routing + auth flow) | ✅ Complete (Session 9, branch `feature/phase1c-fep` HEAD `e62b703`, 37 tests; Card client mocked — live wiring Stage 5) |
